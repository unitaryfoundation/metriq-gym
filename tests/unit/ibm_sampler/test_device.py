...
def test_submit_uses_session(mock_device):
    ...
    with (
        ...
        result = mock_device.submit([qc], shots=100, use_session=True)
...
def test_submit_with_twirling_options(mock_device):
    ...
    with (
        ...
        result = mock_device.submit([qc], shots=100, twirling_options=twirling, use_session=True)
...
def test_submit_with_parameter_pubs(mock_device):
    ...
    with (
        ...
        result = mock_device.submit(pubs, shots=100, use_session=True)
...
def test_submit_multiple_pubs(mock_device):
    ...
    with (
        ...
        result = mock_device.submit([qc1, qc2], shots=50, use_session=True)
