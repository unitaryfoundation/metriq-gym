...
from metriq_gym.run import setup_device, get_example_file_path, dispatch_all_benchmarks, dispatch_job
...
def test_dispatch_all_benchmarks_success(mock_exists, mock_setup_benchmark, mock_load_validate, mock_setup_device, mock_args, mock_job_manager, capsys):
...
@patch("metriq_gym.run.load_and_validate")
@patch("os.path.exists")
def test_dispatch_all_benchmarks_with_exclusions(mock_exists, mock_load_validate, mock_setup_device, mock_args, mock_job_manager, capsys):
...
@patch("os.path.exists")
def test_dispatch_all_benchmarks_missing_example_file(mock_exists, mock_args, mock_job_manager, capsys):
...
@patch("metriq_gym.run.setup_device")
@patch("metriq_gym.run.setup_benchmark")
def test_dispatch_job_calls_single_benchmark(mock_setup_benchmark, mock_setup_device, mock_load_validate, mock_args, mock_job_manager):
